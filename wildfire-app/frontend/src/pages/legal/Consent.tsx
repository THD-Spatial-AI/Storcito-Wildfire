    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none text-foreground">
        <p>
          ...
          related to my use of WildfireApp.
        </p>
        <p>
          I understand that any data I provide for wildfire model creation will be used solely for
        ...
        <p>
          ...
          time by contacting the WildfireApp Team from the Deggendorf University of Technology at{" "}
          <a href="mailto:wildfire-app@th-deg.de">wildfire-app&#64;th-deg.de</a>. Upon revocation, my
        ...
        <p>
          ...
          notified of significant changes, and my continued use of WildfireApp after such
