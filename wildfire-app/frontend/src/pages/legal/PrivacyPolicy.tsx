  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none text-foreground">
        <p>
          WildfireApp is a web application managed and curated by the WildfireApp Team at the
        ...
        <p>
          Javascript is used as the active component for webpages and is required for WildfireApp to
          function. If you have disabled this function in your browser, you will see the relevant
          prompt to re-activate it.
        </p>
        <h3 id="log-files">Log Files</h3>
        <p>
          When a user accesses WildfireApp and when they retrieve a file, this process may store data
        ...
        <p>
          Cookies and entries in local storage are crucial for the functioning of WildfireApp,
        ...
        <ul>
          ...
          <li>
            <strong>wildfire-app_session</strong>
            <ul>
              <li>
                <strong>Storage Period</strong>: 2 hours
              </li>
              <li>
                ...
                while interacting with WildfireApp. It allows the application to remember your
        ...
        <p>
          Local storage is utilized by WildfireApp to manage authentication, security and
        ...
        <p>
          ...
          secure access to WildfireApp's services.
        </p>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                configurations to enhance your experience on WildfireApp. It is not linked to our
        ...
        <p>
          ...
          configurations within WildfireApp.
        </p>
        <p>
        ...
        <p>
          ...
          site may place cookies. WildfireApp has no legal responsibility for these cookies. For
          information regarding the use of such cookies and the information stored in them, please
          check their privacy policies.
        </p>
        <p>
          All operated servers on which personal data are processed or recorded for WildfireApp users
        ...
        <p>
          ...
          <br />
          If WildfireApp instructs partner companies to perform particular services, the data
        ...
        <p>
          <strong>Contacting WildfireApp using feedback forms:</strong> <br /> To correct errors on
          WildfireApp feedback forms can be used to send us a query or notification. This can be done
        ...
        <p>
          WildfireApp also acts as a (co-) organiser of various events.
          <br />
          In the case of an invitation to or participation in an event, WildfireApp will process
        ...
        <p>
          The personal data provided to WildfireApp for this purpose are indicated in the relevant
        ...
        <p>
          ...
          stored and processed for internal use within WildfireApp and for the purpose of organising
          and running events (such as compiling guest lists, enabling entry checks, etc.) WildfireApp
          may arrange for data to be forwarded to one or more contractual processors that use(s)
          personal data at the instruction of WildfireApp and only for internal use that is
          attributable to WildfireApp.
        </p>
        <p>
          Depending on the nature of the event, WildfireApp shall act as a co-organiser alongside an
        ...
        <p>
          Within the scope of performing WildfireApp's press and public relations duties, video/audio
