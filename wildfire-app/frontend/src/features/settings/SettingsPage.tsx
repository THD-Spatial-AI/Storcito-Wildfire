...
const SettingsPage: React.FC = () => {
  ...
  const statsCards = [
    ...
    { title: t('settings.stats.accessLevel'), value: getAccessLevelLabel(user?.access_level), icon: <User className="w-3.5 h-3.5 text-muted-foreground" /> },
  ];
              ...
              <div className="bg-gradient-to-br from-muted/50 to-card rounded-lg p-3 border border-border">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-muted-foreground uppercase tracking-wider">Guidance preferences</p>
                  </div>
                </div>
