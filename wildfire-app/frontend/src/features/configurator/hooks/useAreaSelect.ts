...
export const useAreaSelect = ({
    ...
    const exposedState: AreaSelectState = {
        ...
        selectedRegionName: drawing.selectedRegionName,
        selectedRegionCountry: drawing.selectedRegionCountry,
        isResolvingRegion: drawing.isResolvingRegion,
        regionSelectionError: drawing.regionSelectionError,
    ...
    const actions: AreaSelectActions = {
        ...
        beginRegionSelection: drawing.beginRegionSelection,
        handleRegionSelected: drawing.handleRegionSelected,
        handleRegionSelectionError: drawing.handleRegionSelectionError,
        cancelRegionSelection: drawing.cancelRegionSelection,
