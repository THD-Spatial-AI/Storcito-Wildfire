...
export const isExpert = (user: { access_level?: string } | null | undefined): boolean =>
    user?.access_level === "expert";

export const isManager = (user: { access_level?: string } | null | undefined): boolean =>
    user?.access_level === "manager";

export const isExpertOrManager = (user: { access_level?: string } | null | undefined): boolean =>
