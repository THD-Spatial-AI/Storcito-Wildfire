...
func NewSettingsHandler(db *gorm.DB) *SettingsHandler {
	return NewSettingsHandlerWithStore(settingsStore.NewStore(db))
}

func NewSettingsHandlerWithStore(store services.SettingsStore) *SettingsHandler {
...
func (h *SettingsHandler) UpdateSettings(c *gin.Context) {
	...
	var req contracts.SettingsUpdate
	if err := c.ShouldBindJSON(&req); err != nil {
		httputil.BadRequest(c, errInvalidRequestData)
		return
	}
